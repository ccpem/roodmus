...
TRAJ=$"DESRES-Trajectory_sarscov2-11021566-all-glueCA"
N_CONFS=8334

PDB_DIR=$"/mnt/parakeet_storage4/ConformationSampling/"$TRAJ$"/even_sampling_"$N_CONFS
MRC_DIR=$"run_parakeet_example"
